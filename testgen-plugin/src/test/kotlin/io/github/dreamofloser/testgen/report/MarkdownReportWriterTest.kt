...
class MarkdownReportWriterTest {
    ...
    fun writesQualityAndRiskSections() {
        ...
        val summary = GenerationSummary(
            ...
            generatedClasses = listOf(
                GeneratedClassResult(
                    sourceClass = "com.example.Example|Repository",
                    testClass = "com.example.Example|RepositoryGeneratedTest",
                    testFile = testFile,
            ...
            llmAgentReport = LlmAgentReport(
                ...
                planningSuggestions = listOf(
                    LlmSuggestion(
                        ...
                        recommendation = "Stub API | verify call.\nReturn deterministic data.",
        ...
        assertTrue(report.contains("com.example.Example\\|Repository"))
        assertTrue(report.contains("com.example.Example\\|RepositoryGeneratedTest"))
        assertTrue(
            report.contains(
                "Unsupported \\| declaration<br>Manual review required.",
            ),
        )
        assertTrue(
            report.contains(
                "Stub API \\| verify call.<br>Return deterministic data.",
            ),
        )
    }
}
